...
step "Environment Variables — add exactly these names (mark passwords hidden if the UI can):"
step "  POSTGRES_USER, POSTGRES_PASSWORD, POSTGRES_DB"
step "  NUXT_BETTER_AUTH_SECRET"
step "  NUXT_PUBLIC_SITE_URL=$PREVIEW_URL"
step "Do not paste DATABASE_URL or NUXT_DATABASE_URL; compose builds those on hostname postgres."
