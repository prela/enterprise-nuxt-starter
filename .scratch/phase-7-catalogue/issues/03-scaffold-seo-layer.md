...
A Product can `extends` `@starter/seo` and get robots, sitemap, and Open Graph defaults that use Core’s public site URL. There is no second origin env. A Host may `noindex` routes.
